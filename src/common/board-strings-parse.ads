package Board.Strings.Parse is
    ...
    subtype Parser_Index_t is Natural range 1 .. 8;
    ...
    function Parser_From_Callback     (Item : in String; Move : in out Move_t) return Natural
      with Pre => 0 <= Item'Length and Item'Length <= 2;
    ...
    Parser_From_S      : aliased constant String := "[a-h]?[1-8]?";
    ...
    Parser_From_L      : aliased constant String := "From (" & Parser_From_S & ")";
    ...
    Parser_From      : constant Parser_Node_t := (Kind => State,
                                                  Label => Parser_From_L'Access,
                                                  Length => 2,
                                                  Expr => Parser_From_S'Access,
                                                  Eval => Parser_From_Callback'Access);
    ...
    (
        (False, True,  True,  True,  True,  False, False, False), -- start     -> piece | from | capture | to
        (False, False, True,  True,  True,  False, False, False), -- piece     -> from | capture | to
        (False, False, False, True,  True,  False, False, False), -- from      -> capture | to
        (False, False, False, False, True,  False, False, False), -- capture   -> to
        (False, False, False, False, False, True,  True,  True),  -- to        -> promotion | status | stop
        (False, False, False, False, False, False, True,  True),  -- promotion -> status | stop
        (False, False, False, False, False, False, False, True),  -- status    -> stop
        (False, False, False, False, False, False, False, False)  -- stop
    );
    
    
    function Traverse(Item : in String) return Move_t
